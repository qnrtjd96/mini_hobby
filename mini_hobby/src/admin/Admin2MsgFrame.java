...
public class Admin2MsgFrame extends JPanel {
	//탭 배경설정을 위한 부모 패널 
	...
	public Admin2MsgFrame() {
		...
		//받은 쪽지함
		MsgTab.addTab("받은쪽지", new AdminReceiveMsg().mainPane);
		//보낸쪽지함
		MsgTab.addTab("보낸쪽지", new AdminSendMsg().mainPane);
		//쪽지쓰기
		MsgTab.addTab("쪽지쓰기", new AdminMsgWrite());
		//실시간 채팅 
		MsgTab.addTab("실시간채팅", new AdminLiveChat());
