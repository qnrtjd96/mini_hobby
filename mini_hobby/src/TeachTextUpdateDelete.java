...
public class TeachTextUpdateDelete extends JFrameExtends implements ActionListener, ItemListener{
	...
	public TeachTextUpdateDelete() {
		...
		detail.setFont(fntBold20);pay.setFont(fntBold20);time.setFont(fntBold20);updateBtn.setFont(fntBold15); deleteBtn.setFont(fntBold15);
