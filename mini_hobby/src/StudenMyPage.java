...
public class StudenMyPage extends TeachMyMenu{
	...
	public StudenMyPage() {
		...
		paneRight.add(charge); 
		paneRight.add(cal); calendar_Tea();
		paneRight.add(blue);  paneRight.add(red);
		paneRight.add(ture1); paneRight.add(false1);
		
		paneRight.add(total); paneRight.add(lab1);
		paneRight.add(grap);	  paneRight.add(lab2);
							  paneRight.add(lab3);
